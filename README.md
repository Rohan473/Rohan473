...
Quantitative researcher & ML / data engineer. I build systematic-trading research
tooling and end-to-end data/ML systems — the parts that have to be reproducible,
not just demo-able. B.Tech @ IIIT Guwahati.

🔭 **Now:** a knowledge graph + memory layer that designs, simulates, and gates
systematic alphas on WorldQuant Brain — with overfit & correlation guards baked in.

🛠️ **Stack:** Python · pandas/NumPy · NetworkX · FastAPI · Postgres · Streamlit ·
MCP / LLM agents · React · SQL
...
### Reach me
📧 rohan.patil22b@iiitg.ac.in  ·  🌐 [rohan473.github.io](https://rohan473.github.io/)
